...
解法：解不了，应该存在问题
注意故障开始时间此解法是认为发现6个错误的时候才开始故障区间的

## OD5_2 Excel单元格数值统计 NA AC
题目描述
...
解法：
逻辑解法 1. 转换Excel坐标 2. 判断操作（递归调用函数），知道找到值为止
需手动写一次
注意正则的用法
